function init() {
  ...
  let option2Text = document.createTextNode("Option 2");
  option2.appendChild(option2Text);

  let option3 = document.createElement("option");
  option3.setAttribute("value", "value3");
  let option3Text = document.createTextNode("Option 3");
  ...
  let selectContenedor = document.getElementsById("select-contenedor");
